...
$sql = "SELECT name, SUM(quantity) as total_quantity,price, SUM(price * quantity) as total_price ,date
        FROM inventory_list group by name";
...
?>
	...
	<main>
       <br>
		...
		<br>
		<form action="inventory_report_2.php" method="post">
            <h3>For Monthly Report... </h3>
            <B> Month : </B><input type="number" name="month" min="1" max="12" style="border-radius:7px">&nbsp;&nbsp;
            &nbsp;&nbsp;
            <B> Year : </B><input type="number" name="year" style="border-radius:7px">&nbsp;&nbsp;
            &nbsp;&nbsp;
